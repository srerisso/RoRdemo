...
class ArticulosTest < ApplicationSystemTestCase
  ...
  test "creating a Articulo" do
    ...
    fill_in "Codigo", with: @articulo.codigo
    fill_in "Codigopropio", with: @articulo.codigoPropio
    fill_in "Descripcion", with: @articulo.descripcion
    fill_in "Image url", with: @articulo.image_url
    fill_in "Nombre", with: @articulo.nombre
    fill_in "Precio1", with: @articulo.precio1
